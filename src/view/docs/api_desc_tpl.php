    ...
    <h2 class="ui header">
      ...
      <div class="content">
        ...
        <div class="sub header"><?php echo $description; ?></div>
            ...
            <h4><i class="linkify in alternate icon"></i><?php echo \PhalApi\T('API Url'); ?>：<?php echo $apiUrl; ?></h4>
            <h3><?php echo $apiMethod; ?></h3>
...
foreach ($returns as $item) {
    ...
    echo "<tr><td>$name</td><td>$type</td><td>$desc</td></tr>";
}
...
EOT;
    ...
    foreach ($exceptions as $exKey => $exMsg) {
        echo "<tr><td>$exKey</td><td>$exMsg</td></tr>";
    }
...
$thisYear = date('Y');
$tips = \PhalApi\T('Tips: ');
$helpMsg = '接口文档根据配置自动生成'; //\PhalApi\T('This API Document will be generated automately by PHP code and comments. More detail please visit <a href="{url}" target="_blank">Docs</a>.', array('url' => 'http://docs.phalapi.net/#/v2.0/api-docs'));
echo <<<EOT
